            ...
            <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white p-3" type="file" name="image" required>
                        @error('image')
                    ...
                    <div>
                        <label class="text-gray-700" for="name">LINK GALERI</label>
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="link" value="{{ old('link') }}" placeholder="Link ke Galeri">
                        @error('link')
                        <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                            <div class="px-4 py-2">
                                <p class="text-gray-600 text-sm">{{ $message }}</p>
                ...
                <table class="min-w-full table-auto">
                    <thead class="justify-between">
                        <tr class="bg-gray-600 w-full">
                            ...
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">LINK GALERI</span>
                            </th>
                            <th class="px-16 py-2">
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="border bg-white">
                            ...
                            <td class="px-16 py-2">
                                <a href="{{ $slider->link }}" target="_blank" class="text-blue-500 underline">{{ $slider->link }}</a>
                            </td>
